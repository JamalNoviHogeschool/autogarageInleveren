package com.autogarage.security;

import com.auth0.jwt.JWT;
import com.auth0.jwt.JWTVerifier;
import com.auth0.jwt.algorithms.Algorithm;
import com.auth0.jwt.interfaces.DecodedJWT;
import com.autogarage.model.dto.security.AutoGarageUserDetails;
...
public class JWTAuthenticationFilter extends OncePerRequestFilter {
    ...
    private UsernamePasswordAuthenticationToken getAuthenticationFromMobileNo(String userName, Collection<SimpleGrantedAuthority> authorities) {
        ...
        AutoGarageUserDetails userDetails = new AutoGarageUserDetails(userDTO);
